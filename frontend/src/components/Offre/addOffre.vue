    ...
    <div>
        <div class="">
            <section id="login" class="p-4 flex flex-col justify-center min-h-screen max-w-md mx-auto">
                <div class="p-6 bg-gray-600 rounded">
                    <div class="flex items-center justify-center font-black m-3 mb-12">
                        ...
                        <h1 class="tracking-wide text-3xl text-gray-900">POSTER</h1>
                    ...
                    <form id="login_form" @click="subsub" action="api_login" method="POST"
                        ...
                        <div class="container mx-auto h-full flex flex-col justify-center items-center">
                            <input @change="processFile($event)" type="file" id="multi-upload-input" multiple />
                        </div>
                        ...
                        <div v-if="offre" class="flex justify-between items-center mb-3">
                            <div class="inline-flex items-center self-start">
                                ...
                                <span class="font-bold text-gray-900">$5 / Prix</span>
                            </div>
                            <div class="flex">
...
export default {
    ...
    methods: {
        ...
        subsub() {
            ...
            parseInt(document.getElementById("item_count").value)
            this.subtotal = parseInt(5)
        },
        typefun() {
