<template>
    <div class="fixed top-0 right-0 bg-opacity-70 bg-black w-full ">
        <section id="login" class="p-4 flex flex-col justify-center min-h-screen max-w-md mx-auto">
            <div class="p-6 bg-gray-700 rounded">
                <div class="flex items-center justify-center font-black m-3 mb-12">
                    ...
                    <h1 class="tracking-wide text-3xl text-white">Update</h1>
                ...
                <form id="login_form" @submit.prevent="" @click="subsub" enctype="multipart/form-data" method="POST"
                    ...
                    <div class="container mx-auto h-full flex flex-col justify-center items-center">
                        <input @change="uploadImage" type="file" accept=".png,.jpg,.jpeg" :maxFileSize="1048576000000"
                            id="multi-upload-input" multiple />
                    </div>
        ...
        <div v-if="send" class="bg-black bg-opacity-60 w-full h-screen fixed top-0 flex justify-center items-center">
            <lottie-player src="https://assets8.lottiefiles.com/packages/lf20_c6vz1igk.json" background="transparent"
